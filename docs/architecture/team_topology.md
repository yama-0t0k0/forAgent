...
| :--- | :--- | :--- | :--- |
| **pm_agent** | 指令塔 (Orchestrator) | `README.md`, `.agent/` | 要件定義、タスク分解、全体管理、GitHub管理 |
...
### A. 開発のメインループ
1. **[PM]** ユーザーの要望を `implementation_plan.md` に落とし込み、タスクを割り振る。
2. **[Apps]** 実装に着手。共通化が必要な部品を見つけた場合、**[Shared]** に相談・依頼する。
...
7. **[PM]** 最終報告を行い、GitHub Issue を Close する。
