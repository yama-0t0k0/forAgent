...
class HeatmapMapper {
  static const int totalTiles = 90;

  // スキル（0〜44）
  static const Map<String, int> skillMapping = {
    // OS (0-4)
    'Mac': 0,
    'Linux': 1,
    'Windows': 2,
  ...
  // 志向（45〜89）
  static const Map<String, int> aspirationMapping = {
    // 希望職種 (45-53)
    'サーバサイドエンジニア': 45,
    'フロントエンドエンジニア': 46,
    'インフラ系エンジニア': 47,
  ...
  static int? getIndex(String key, {bool isAspiration = false}) {
    if (isAspiration) {
      return aspirationMapping[key];
    }
